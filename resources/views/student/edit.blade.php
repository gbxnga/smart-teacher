...
@section('title')
Edit Student Record | SmartTeacher
@endsection
@section('content')
                    ...
                    <div class="box box-success">
                        ...
                        <form role="form" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select id="class_id" name="class_id" class="form-control">
                                                ...
                                                @foreach($classes as $class)
                                                    ...
                                                    <option <?php if ($class->id === $student->class_id) echo 'selected="selected"'; ?> value="{!! $class->id !!}">{!! $class->name !!}</option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select id="section_id" name="section_id" class="form-control">
                                                ...
                                                @foreach($sections as $section)
                                                    ...
                                                    <option <?php if ($section->id == $student->section_id) echo 'selected="selected"'; ?> value="{!! $section->id !!}">{!! $section->name !!}</option>
                            ...
                            <div class="box-footer">
                                <button type="submit" class="btn btn-success" name="submit" value="update">Update Record</button>
                            </div>
                        </form>
                    </div>
                    <!-- /.box -->
